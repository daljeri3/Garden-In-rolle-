...
create table if not exists leaves (
  ...
  medical_letter_path text, -- storage path, required for Sick leave (Article 69)
...
-- ---- Storage: private bucket for medical certificates (Article 69 requires
-- a real medical report before sick leave is paid) ----
...
-- Staff upload into a folder named after their own employee id; managers
-- can read everything, staff can only read their own uploads.
